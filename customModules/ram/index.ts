...
import type { BarBoxChild, ResourceLabelType } from 'lib/types/bar';
...
import type { Attribute, Child } from 'lib/types/widget';
...
// @ts-ignore - We'll handle the type casting carefully
const ramUsage: Variable<GenericResourceData> = Variable(defaultRamData);



pollVariable(ramUsage, [round.bind('value')], pollingInterval.bind('value'), calculateRamUsage, round);

// @ts-ignore - The types are complex here, but the runtime behavior is correct
